...
<html>
<head>
	<title>Shade Bootstrap Template | Login</title>
	...
	<section id="main">
		<div class="content">
			...
			<div class="coats">
				...
				<p>Lorem ipsum dolor sit amet enim. Etiam ullamcorper suspendisse a pellentesque.</p>
			</div>
			...
			<div class="coats login-bot">
				...
				<p>Lorem ipsum dolor sit amet enim. Etiam ullamcorper suspendisse a pellentesque.</p>
				<div class="reg">
					<a href="register.action">Register Here</a>
				</div>
			</div>
			<div class="look">
			...
			<div class="partner">
				...
				<script type="text/javascript" src="<%=request.getContextPath()%>/template/js/jquery.flexisel.js"></script>
			</div>
			...
			<div class="footer">
				<div class="row footer-row">
					...
					<div class="col-md-3 foot-cl">
						...
						<p>Shoper is made with love in Warsaw,<br>2014 &copy; <a target="_blank" href="http://www.mobanwang.com/">网页模板</a></p>
						<ul class="social">
							<li><i class="fa"></i></li>
							<li><i class="tw"></i></li>
							<li><i class="is"></i></li>
