...
<html>
<head>
	<title>Shade Bootstrap Website Template | Basket</title>
		...
		<div class="content">
			<div class="pag-nav">
				<ul class="p-list">
					...
					<li class="act">&nbsp;Basket(0)</li>
				</ul>
			</div>
			<div class="coats sing-c">
				<h3 class="c-head">Your Basket(0)</h3>
				<p>Lorem ipsum dolor sit amet enim. Etiam ullamcorp uspendisse a pellentesque.</p>
				<p>Your Basket Is Empty Please Go <a href="men.action">here</a> And Shop</p>
			</div>
