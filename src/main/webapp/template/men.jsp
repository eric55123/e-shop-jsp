...
<html>
<head>
	<title>Shade Bootstrap Website Template | Men</title>
...
<div class="container">
	<section id="main">
		<div class="content">
			...
			<!-- 多組商品展示 -->
			<jsp:include page="men_coats.jsp" />
			<jsp:include page="men_outerwear.jsp" />
			<jsp:include page="men_tshirts.jsp" />

			<div class="look"><h3>Check our lookbook</h3></div>
